...
all_image_list  = client.images.list()
count=1
...
for image in all_image_list:
            ...
            print("This will be your image number: ",count )
            time.sleep(0.5)
            ...
            count= count+1
            print("This is the image image with tag:- ", image)
            time.sleep(0.5)

            print("This is the image id:- ",image.id)
            time.sleep(0.5)
